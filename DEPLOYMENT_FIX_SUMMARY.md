...
## Root Cause
- **Frontend `.env`** had: `REACT_APP_BACKEND_URL=https://payment-fix-47.preview.emergentagent.com`
- **Backend `.env`** had: `REACT_APP_BACKEND_URL=https://payment-fix-47.preview.emergentagent.com`
